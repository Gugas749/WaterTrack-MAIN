...
@Database(entities = {UserInfosEntity.class, MeterEntity.class, MeterReadingEntity.class, AvariasContadoresEntity.class, EnterpriseEntity.class, TecnicoInfoEntity.class, MeterTypeEntity.class}, version = 2)
