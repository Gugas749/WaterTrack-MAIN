...
public class LocalDBgetAll {
    ...
    public List<ReportsEntity> avariasContadoresEntityList;
    ...
    public LocalDBgetAll(List<MeterReadingEntity> logsContEntityList, List<MeterEntity> contadoresEntityList, List<ReportsEntity> avariasContadoresEntityList, List<EnterpriseEntity> enterpriseEntityList, List<MeterTypeEntity> meterTypeEntityList, UserInfosEntity userInfo) {
